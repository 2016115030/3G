...
function getLastFm() {
    ...
    $key      = '2a83bf423ea1f964b8c430dca20805dc'; // Enter your API Key
    // $status   = 'Last Played:'; // default to this, if 'Now Playing' is true, the json will reflect this.
    $endpoint = 'https://ws.audioscrobbler.com/2.0/?method=track.getInfo&api_key=2a83bf423ea1f964b8c430dca20805dc&artist=cher&track=believe&format=json';
    ...
    $artwork = $lastfm['track']['album']['image'][2]['#text'];
    ...
    $trackInfo = [
        ...
        'artist'     => $lastfm['track']['artist']['name'],
        'link'       => $lastfm['track']['url'],
        'albumArt'   => $artwork,
        // 'status'     => $status
    ];
